...
bool z21::onAccessoryData(uint16_t accessoryId, uint8_t port, uint8_t type, uint32_t value)
{
  ...
  EthSend(0x00, 0x0E, z21Interface::Header::LAN_CAN_DETECTOR, data, true, (static_cast<uint16_t>(BcFlagShort::Z21bcAll) | static_cast<uint16_t>(BcFlagShort::Z21bcNetAll)));
  return true;
}
